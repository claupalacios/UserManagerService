...
namespace UserManagerService_Test.Services
{
    public class UserServiceTest
    {
        ...
        [Test]
        public void DeleteUser_ShouldReturnIsSuccessTrue_When_IdExist()
        {
            //Arrange
            var userId = 1;

            _mockUserRepository
                .Setup(m => m.DeleteUser(userId)).Returns(true);

            //Act
            var res = target.DeleteUser(userId);
        ...
        [Test]
        public void DeleteUser_ShouldReturnIsSuccessFalse_When_IdNotExist()
        {
            //Arrange
            var userId = 2;

            _mockUserRepository
                .Setup(m => m.DeleteUser(userId)).Returns(false);
